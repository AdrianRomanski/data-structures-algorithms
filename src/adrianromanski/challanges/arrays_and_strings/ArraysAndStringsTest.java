...
//            zeroer2 = new Zeroer2();
    ...
    public void UniqueCharacters() {
        ...
        // unique chars
        assertTrue(charDetector.isUnique1("ab"));
        assertFalse(charDetector.isUnique1("aa"));
        assertTrue(charDetector.isUnique1("abcdefghijklmnopqrstuvwxyz"));

        assertTrue(charDetector.isUnique2("ab"));
...
//            // - use of ArrayList
//            // - use or no use o
//            f immutable (creating many arrays vs changing original)
